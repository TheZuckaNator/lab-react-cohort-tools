...
function StudentDetailsPage() {
  // Get the studentId from URL parameters
    ...
    return (
      <div className="StudentDetailsPage bg-gray-100 py-6 px-4 border-2 border-fuchsia-500 m-2">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md mb-6">
          <p className="text-red-500 text-xl">Student not found!</p>
          <Link 
            to="/" 
            className="text-white px-4 py-2 rounded bg-green-500 hover:bg-green-600 transition duration-300 ease-in-out inline-block mt-4"
          >
            Back to Home
          </Link>
        </div>
